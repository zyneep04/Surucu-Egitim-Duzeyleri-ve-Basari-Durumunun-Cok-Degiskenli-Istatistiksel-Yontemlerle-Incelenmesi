/* Adapted from Manova.sas (zyneep04/Surucu-Egitim-Duzeyleri...) for Jenner.
   Original script read Drivers from an SPSS .sav import; this bundle builds
   an equivalent Drivers dataset in-line from a sample of the repo's own
   DriversLicenseData.csv so the MANOVA logic below runs unmodified. */
